 ...
 * RMS EcoSky
 *
 * Copie SERVEUR (Node / ES modules) : importée par les fonctions api/*.js via
 * `import PRICING_CONFIG_ANC from "./anc-pricing-config-server.js"`.
 *
 * ⚠️ Une copie identique en CONTENU (mêmes prix, même structure) existe côté
 * navigateur sous le nom public/pricing-config-anc.js, mais dans un format
 * différent (UMD, pour fonctionner avec une balise <script> classique) — ce
 * n'est PAS un fichier partagé. Si tu modifies un prix, répercute-le dans LES
 * DEUX fichiers.
 *
 ...
 * Au-delà, prixParEH reste null → « estimation à confirmer par un technicien ».
 */
