 ...
 * RMS EcoSky
 *
 * Copie SERVEUR (Node/ESM) : importée par api/submit-estimation-anc.js et
 * api/extraire-etude-anc.js via `import PRICING_CONFIG_ANC from
 * "./anc-pricing-config-server.js"`.
 *
 * ⚠️ Une copie identique existe côté navigateur sous le nom
 * public/pricing-config-anc.js (nom différent volontairement, pour éviter
