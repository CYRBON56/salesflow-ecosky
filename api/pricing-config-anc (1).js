 ...
 * RMS EcoSky
 *
 * Fichier UMD : utilisable tel quel côté navigateur (public/estimation-anc.html,
 * via <script src="pricing-config-anc.js">, expose window.PRICING_CONFIG_ANC)
 * ET côté serveur (api/submit-estimation-anc.js, via require('./pricing-config-anc.js')).
 *
