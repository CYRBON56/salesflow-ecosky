    ...
    const lignesHtml = lignes.map(l => {
      ...
      <tr>
        ...
        <td>
          ...
          <a class="btn-lien" href="https://salesflow-ecosky.vercel.app/estimation.html?lead_id=${l.id}" target="_blank" rel="noopener">📋 Détails</a>
